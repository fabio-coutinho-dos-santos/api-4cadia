...
//const passwordRegex = /((?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).{6,12})/ //com character especial, maiúscula e minuscula e numero
// const passwordRegex = /((?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,12})/  //com maiúscula e minuscula e numero
const passwordRegex = /((?=.*\d)(?=.*[a-z]).{6,12})/ //com minuscula e numero
